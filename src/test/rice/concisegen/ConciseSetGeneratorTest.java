...
class ConciseSetGeneratorTest {
    ...
    void testNeedOneAllWrong() {
        ...
        for (int i = 0; i < 9; i++) {
            caseToFiles.add(new HashSet<>(Set.of(i, i + 1)));
        }
    ...
    void testNeedOneSomeWrong() {
        ...
        Set<Integer> wrongSet = new HashSet<>(Set.of(1, 3, 5, 7, 9));
        ...
        for (int i = 0; i < 9; i++) {
            if (i % 2 == 0) {
                ...
                caseToFiles.add(new HashSet<>(Set.of(i + 1)));
            } else {
                caseToFiles.add(new HashSet<>(Set.of(i)));
            }
        }
    ...
    void testEachFileFailsOneTest() {
        ...
        for (int i = 0; i <= 9; i++) {
            if (i % 2 == 0) {
                ...
                caseToFiles.add(new HashSet<>(Set.of(i / 2)));
            } else {
                // Odd tests don't catch anything
                caseToFiles.add(new HashSet<>(Set.of()));
            }
        }
    ...
    void testGreedyNotOptimal() {
        ...
        List<Set<Integer>> caseToFiles = new ArrayList<>();
        for (int i = 0; i < 5; i++) {
            caseToFiles.add(new HashSet<>(Set.of(i, i + 5)));
        }
