...
class TestCaseTest {
    ...
    void testToStringMultipleArgsNested() {
        ...
        assertTrue(Arrays.asList(options).contains(multipleArgsNested.toString()));
    }
    ...
    private static void setUpOneArgSimpleVal() {
        ...
        oneArgSimpleVal = Arrays.asList(new APyObj<?>[]{new PyIntObj(17)});
    ...
    private static void setUpOneArgNestedVal() {
        ...
        PyTupleObj<PyStringObj> nestedArgMiddle1 =
                new PyTupleObj<>(Arrays.asList(nestedArgInnermost1, nestedArgInnermost2));
        ...
        PyListObj<PyTupleObj<PyStringObj>>
                nestedArg1 =
                new PyListObj<>(Arrays.asList(nestedArgMiddle1, nestedArgMiddle2));
        oneArgNestedVal = Arrays.asList(new APyObj<?>[]{nestedArg1});
    ...
    private static void setUpMultipleArgsNestedVal() {
        ...
        PyListObj<PyTupleObj<PyStringObj>>
                nestedArg1 =
                new PyListObj<>(Arrays.asList(nestedArgMiddle1, nestedArgMiddle2));
        oneArgNested2 = new TestCase(Arrays.asList(new APyObj<?>[]{nestedArg1}));
        ...
        PyTupleObj<PyBoolObj>
                nestedArg3Middle1 = new PyTupleObj<>(Arrays.asList(pyTrue, pyFalse, pyTrue));
        PyTupleObj<PyBoolObj> nestedArg3Middle2 =
                new PyTupleObj<>(Collections.singletonList(pyFalse));
        PyTupleObj<PyBoolObj>
                nestedArg3Middle3 = new PyTupleObj<>(Arrays.asList(pyFalse, pyFalse));
        ...
        multipleArgsNestedVal = Arrays.asList(nestedArg1, nestedArg2, nestedArg3);
