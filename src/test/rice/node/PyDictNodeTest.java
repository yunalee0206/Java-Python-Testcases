...
class PyDictNodeTest extends APyNodeTest {
    ...
    private static void setUpTwoLenOne() {
        ...
        twoLenOneVal.setExDomain(List.of(1, 0));
        twoLenOneVal.setRanDomain(List.of(0, 1));
    ...
    private static void setUpFourLenTwo() {
        ...
        fourLenTwoKey.setExDomain(List.of(1, 0));
        fourLenTwoKey.setRanDomain(List.of(0, 1));
    ...
    private static void setUpManyLenTwo() {
        ...
        manyLenTwoKey.setExDomain(List.of(1, 2, 0));
        manyLenTwoKey.setRanDomain(List.of(1, 2, 0));
        PyIntNode manyLenTwoVal = new PyIntNode();
        manyLenTwoVal.setExDomain(List.of(4, 3));
        manyLenTwoVal.setRanDomain(List.of(3, 4));
    ...
    private static void setUpVariedLens() {
        ...
        lenZeroToFourKey.setExDomain(List.of(5, 4, 3));
        lenZeroToFourKey.setRanDomain(List.of(6, 7, 8, 9));

        PyBoolNode lenZeroToFourVal = new PyBoolNode();
        lenZeroToFourVal.setExDomain(List.of(0, 1));
        lenZeroToFourVal.setRanDomain(List.of(0, 1));
        ...
        lensZeroToFour.setExDomain(List.of(0, 2));
        lensZeroToFour.setRanDomain(List.of(1, 4));
    }
    ...
    private static void setUpNested() {
        ...
        innerKey.setExDomain(List.of(3.7, 7.3));
        innerKey.setRanDomain(List.of(3.7, 7.3));
        ...
        outerKey.setExDomain(List.of(1.1, 2.2));
        outerKey.setRanDomain(List.of(-1.1, -2.2));
