...
class PySetNodeTest extends APyNodeTest {
    ...
    private static void setUpEmpty() {
        ...
        emptyLeftChild.setExDomain(List.of(0, 1));
        emptyLeftChild.setRanDomain(List.of(0, 1));
    ...
    private static void setUpLenOne() {
        ...
        oneLenOneChild.setRanDomain(List.of(0, 1));
    ...
    private static void setUpLenTwo() {
        ...
        oneLenTwoChild.setExDomain(List.of(0, 1));
        oneLenTwoChild.setRanDomain(List.of(0, 1));
        ...
        threeLenTwoChild.setExDomain(List.of(0, 1, 2));
        threeLenTwoChild.setRanDomain(List.of(0, -1, -2));
    ...
    private static void setUpMixedLen() {
        ...
        child.setExDomain(List.of(3, 5, 7));
        child.setRanDomain(List.of(6, 8, 10));

        lensZeroToTwo = new PySetNode<>(child);
        lensZeroToTwo.setExDomain(List.of(0, 2, 1));
        lensZeroToTwo.setRanDomain(List.of(0, 1, 2));

        lensZeroToThree = new PySetNode<>(child);
        lensZeroToThree.setExDomain(List.of(2, 0));
    ...
    private static void setUpNested() {
        ...
        both.setExDomain(List.of(0, 1, 2));
        both.setRanDomain(List.of(3, 4, 5, 6));
        ...
        nestedInts.setExDomain(List.of(0, 2));
        nestedInts.setRanDomain(List.of(1, 4));
    }
